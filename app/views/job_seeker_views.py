...
def apply_job(request):
    try:
        ...
        sender = request.user
        receiver = CustomUser.objects.get(id=employer.id)
        alumni_full_name = request.user.get_full_name()
        ...
        Notification.objects.create(
            ...
            message=f"{alumni_full_name} applied for your job post: '{job.title}'"
        )
