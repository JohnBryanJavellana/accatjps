...
const UpdateDocFile = ({ id, data, modalTitle, callbackFunction }) => {
    ...
    const SubmitDocumentUpdate = async () => {
        try {
            ...
            await axios.post(`${url}/authenticated/employer/manage-account/update-doc-file`, formData, {
                headers: {
