                                            ...
                                            <div className="w-100 py-3 d-flex align-items-center justify-content-between">
                                                <div>
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <div
                                                            className="mr-2"
                                                            style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: data?.is_ai_recommended ? '#28a745' : '#dc3545' }}
                                                        ></div>
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <span className="h5 mb-0" style={{ fontWeight: '300', color: '#64748b' }}>
                                                        <strong className="text-dark">{data?.total_profile_score}</strong>
