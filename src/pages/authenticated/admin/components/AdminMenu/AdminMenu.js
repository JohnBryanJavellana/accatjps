...
const AdminMenu = () => {
    ...
    const navItems = [
        { label: 'Dashboard', path: '/welcome/administrator/' },
        { label: 'Announcement', path: '/welcome/administrator/announcement' },
        { label: 'User Management', path: '/welcome/administrator/user-management' },
        { label: 'System Settings', path: '/welcome/administrator/system-settings' },
        { label: 'Manage Profile', path: '/welcome/administrator/manage-account' }
    ];
